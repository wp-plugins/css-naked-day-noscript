...
The plugin would cause errors for some inline styles that have escaped quotation marks of the same type as the attribute value delimiter.
...
I recommend as as a much better practice is to use alternating quotation marks for producing this kind of markup. For example:
